...
public class CloseToWall extends AbFunctions
{
	...
	/**
	 * Does a simplified printing of the CloseToWall AbFunctions
	...
	/**
	 * Saves a CloseToWall function to the file
	 * CloseToWall has a code of 0
	...
	{
		//save this function to the file
		out.printf("%d, %d, %d\n", 0, sensorNums[0], -1);
