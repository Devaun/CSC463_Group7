...
public class DoTwoCloseClose extends AbFunctions
{
	...
	/**
	 * Does a simplified printing of the DoTwoCloseClose AbFunctions
	...
	protected boolean replaceNode(int maxDepth, int currentDepth, int nodeToReplace)
	{
		...
		{
			//if true randomly select a node to replace
	...
	/**
	 * Saves a DoTwoCloseClose function to the file
	 * DoTwoCloseClose has a code of 3
	...
	protected void save(PrintWriter out) throws FileNotFoundException
	{
		...
		//Save the left child's branch before the right
		leftChild.save(out);
		rightChild.save(out);
	}
