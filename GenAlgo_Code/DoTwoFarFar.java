...
public class DoTwoFarFar extends AbFunctions
{
	 ...
	 * @param sensorTwo
	 */
	public DoTwoFarFar(int sensorOne, int sensorTwo)
	{
		numSensors = 2;
		sensorNums = new int[numSensors];	
	...
	/**
	 * Does a simplified printing of the DoTwoFarFar AbFunctions
	...
	{
		testTabs(num);
		System.out.println("Do Two Far Far");
	...
	/**
	 * Saves a DoTwoFarFar function to the file
	 * DoTwoFarFar has a code of 2
